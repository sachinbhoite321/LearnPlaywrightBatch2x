...
Welcome to the **Learn Playwright Batch 2x** repository!  
This project contains hands-on JavaScript fundamentals and learning materials organized chapter-wise, aimed at building a strong foundation for Playwright test automation.
...
│   ├── 93_Arrays.Slice.js
│   ├── 94_Concate_Array.js
│   └── 95_Arrays.Checking.js
├── chapter_12_Functions/
│   ├── 96_Functions.js
│   ├── 97_Type1_Basic_Fn.js
│   ├── 98_Type2_Fn_with_para_noret.js
│   ├── 99_Type3_Fn_Without_param_WithReturn.js
│   ├── 100_Type4_with_para_with_return.js
│   ├── 101_Template_literal.js
│   ├── 102_Fn_Expression.js
│   ├── 103_Arrow_Fn.js
│   ├── 104_Arrow_Fn.REAL.js
│   ├── 105_IIFE.js
...
│   ├── 124_Objects.js
│   ├── 125_Objects2.js
│   ├── 126_Object_Creations.js
│   ├── 127_Object_REAL.js
│   ├── 128_Primitive_Ref.js
│   ├── 129_Obj_Example.js
│   ├── 130_IQ.js
│   ├── 131_Object_Fn.js
│   ├── 132_Obj_Deconstruction.js
│   ├── 133_Spread.js
│   ├── 134_Object_GET_SET_Methods.js
│   ├── 135_IQ.js
...
| **Chapter 20** | OOPs Basics in JavaScript | `171_Object_class.js`, `172_Object_class2.js`, `173_Car.js`, `174_REAL_Browser.js`, `175_IQ.js`, `176_Public_Private.js`, `177_Static.js`, `178_Statics.js`, `179_Encaps.js`, `180_Real_Example.js`, `181_Encap_Car.js`, `182_Encap_Bank.js`, `EX1.js`, `EX2.js`, `EX3.js`, `EX4.js`, `Task1.js`, `Task2.js` |
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/sachinbhoite321/LearnPlaywrightBatch2x.git
...
3. **Explore the chapters** in your favorite code editor (we recommend [VS Code](https://code.visualstudio.com/))!
